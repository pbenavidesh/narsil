...
description: "A conceptual introduction to R for students coming from a Python background, focused on mental models, data workflows, and tidyverse-style thinking."
categories: [R]
format: html
---
