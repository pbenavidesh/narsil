...
```{r}
#| label: us-two-residuals-render
#| renderings: [light, dark]
#| echo: false

us_two_residuals_p + theme_narsil()
us_two_residuals_p + theme_narsil_dark()
```
...
```{r}
#| label: us-forecast-full-render
#| renderings: [light, dark]
#| echo: false

us_forecast_full_p + theme_narsil()
us_forecast_full_p + theme_narsil_dark()
```
...
```{r}
#| label: us-interval-compare-render
#| renderings: [light, dark]
#| echo: false

us_interval_compare_p + scale_narsil()
us_interval_compare_p + scale_narsil_dark()
```
...
```{r}
#| label: elec-scatter-render
#| renderings: [light, dark]
#| echo: false

ggplotly(elec_scatter_p + scale_narsil()) |> gg_to_plotly_narsil()
ggplotly(elec_scatter_p + scale_narsil_dark()) |> gg_to_plotly_narsil(dark = TRUE)
```
...
```{r}
#| label: elec-forecast-conservative-plot
#| echo: false
#| output: false

elec_forecast_conservative_plot_p <- forecast(vic_elec_fit, vic_elec_future_26) |>
...
```{r}
#| label: elec-forecast-conservative-plot-render
#| renderings: [light, dark]
#| echo: false

elec_forecast_conservative_plot_p + theme_narsil()
elec_forecast_conservative_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: elec-forecast-heatwave-plot
#| echo: false
#| output: false

elec_forecast_heatwave_plot_p <- forecast(vic_elec_fit, vic_elec_future_hw) |>
  autoplot(vic_elec_daily) +
...
```{r}
#| label: elec-forecast-heatwave-plot-render
#| renderings: [light, dark]
#| echo: false

elec_forecast_heatwave_plot_p + theme_narsil()
elec_forecast_heatwave_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: insurance-plot-render
#| renderings: [light, dark]
#| echo: false

ggplotly(insurance_plot_p + theme_narsil(), dynamicTicks = TRUE) |> gg_to_plotly_narsil()
ggplotly(insurance_plot_p + theme_narsil_dark(), dynamicTicks = TRUE) |> gg_to_plotly_narsil(dark = TRUE)
```
...
```{r}
#| label: insurance-forecast-render
#| renderings: [light, dark]
#| echo: false

insurance_forecast_p + theme_narsil()
insurance_forecast_p + theme_narsil_dark()
```
...
## When Seasonal Dummies Aren't Enough
...
cafe_plot_p <- aus_cafe |> autoplot(Turnover) +
  labs(title = "Australian café & restaurant turnover",
       y = "AUD (millions)", x = NULL)
```

```{r}
#| label: cafe-plot-render
#| renderings: [light, dark]
#| echo: false

cafe_plot_p + theme_narsil()
cafe_plot_p + theme_narsil_dark()
```
...
cafe_forecast_comparison_p <- cafe_fit |>
  forecast(h = "2 years") |>
  autoplot(aus_cafe) +
...
```{r}
#| label: cafe-forecast-comparison-render
#| renderings: [light, dark]
#| echo: false

cafe_forecast_comparison_p + scale_narsil()
cafe_forecast_comparison_p + scale_narsil_dark()
```
...
```{r}
#| label: elec-hourly-plot-render
#| renderings: [light, dark]
#| echo: false

ggplotly(elec_hourly_plot_p + theme_narsil(), dynamicTicks = TRUE) |> gg_to_plotly_narsil()
ggplotly(elec_hourly_plot_p + theme_narsil_dark(), dynamicTicks = TRUE) |> gg_to_plotly_narsil(dark = TRUE)
```
