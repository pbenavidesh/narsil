...
gas_pi_no_bc_p + theme_narsil()
gas_pi_no_bc_p + theme_narsil_dark()
```
...
```{r}
#| label: google-sim-plot-render
#| renderings: [light, dark]
#| echo: false

google_sim_plot_p + theme_narsil() + theme(legend.position = "bottom")
google_sim_plot_p + theme_narsil_dark() + theme(legend.position = "bottom")
```
