...
::: {.content-hidden unless-format="revealjs"}
![Dr. Strange simulating 14,000,605 possible futures via bootstrap](../../00_intro/dr_strange_math.jpg){width=55%}
:::

::: {.content-hidden unless-format="revealjs"}
## `generate()` — simulating paths
:::
...
# `decomposition_model()` — the Module 1 deliverable
