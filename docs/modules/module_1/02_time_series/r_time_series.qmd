...
summarise(group_by(as_tibble(filter(tourism, State == "Tasmania", Region == "East Coast")), Purpose), mean_trips = mean(Trips))
```

:::{.notes}
:::{.callout-note collapse="true"}
## Order of code execution
Note that this code must be read inside-out. This makes it harder to understand, and debug.
:::
:::
