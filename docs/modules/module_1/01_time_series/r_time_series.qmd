...
<!-- The pkg_tidyverse and pkg_fpp3 chunks are visible with message: true on
     purpose: this lesson teaches package loading, and the .notes text explains
     the attach/conflict messages the tidyverse prints on load. Do not hide
     these chunks or set message: false — it would make that text false. -->
