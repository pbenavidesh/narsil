...
```{r}
#| label: hare-plot-render
#| renderings: [light, dark]
#| echo: false

hare_plot_p + theme_narsil()
hare_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: hare-fcst-plot-render
#| renderings: [light, dark]
#| echo: false

hare_fcst_plot_p + scale_narsil()
hare_fcst_plot_p + scale_narsil_dark()
```
...
```{r}
#| label: beer-fcst-plot-render
#| renderings: [light, dark]
#| echo: false

beer_fcst_plot_p + scale_narsil()
beer_fcst_plot_p + scale_narsil_dark()
```
...
```{r}
#| label: gdp-plot-render
#| renderings: [light, dark]
#| echo: false

gdp_plot_p + theme_narsil()
gdp_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: gdp-fcst-plot-render
#| renderings: [light, dark]
#| echo: false

gdp_fcst_plot_p + scale_narsil()
gdp_fcst_plot_p + scale_narsil_dark()
```
...
```{r}
#| label: gas-plot-render
#| renderings: [light, dark]
#| echo: false

gas_plot_p + theme_narsil()
gas_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: gas-fcst-plot-render
#| renderings: [light, dark]
#| echo: false

gas_fcst_plot_p + scale_narsil()
gas_fcst_plot_p + scale_narsil_dark()
```
...
If $H_0$, $p$-values, and the 0.05 threshold are unfamiliar — or if you have
never been told what *failing* to reject actually licenses you to conclude — see
...
```{r}
#| label: hare-refit-render
#| renderings: [light, dark]
#| echo: false

hare_refit_p + theme_narsil()
hare_refit_p + theme_narsil_dark()
```
...
```{r}
#| label: beer-refit-render
#| renderings: [light, dark]
#| echo: false

beer_refit_p + theme_narsil()
beer_refit_p + theme_narsil_dark()
```
...
```{r}
#| label: gdp-refit-render
#| renderings: [light, dark]
#| echo: false

gdp_refit_p + theme_narsil()
gdp_refit_p + theme_narsil_dark()
```
