...
::: {.fragment}
which gives a **perfect square trinomial**^[![](trinomio cuadrado perfecto.jpg)]
...
```{r}
#| label: ar-examples-render
#| renderings: [light, dark]
#| echo: false
#| fig-height: 4

(ar1_examples_p + theme_narsil()) | (ar2_examples_p + theme_narsil())
(ar1_examples_p + theme_narsil_dark()) | (ar2_examples_p + theme_narsil_dark())
```
