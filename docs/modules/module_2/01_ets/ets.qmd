...
: Weights for different values of $\alpha$ {#tbl-ets_alpha_weights .striped .hover}
...
- Conversely, a larger value of $\alpha$ means a shorter memory, with more emphasis on recent observations.
:::
