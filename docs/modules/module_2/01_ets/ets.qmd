...
```{r}
#| label: alg-plot-render
#| renderings: [light, dark]
#| echo: false

alg_plot_p + theme_narsil()
alg_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: ses-plot-render
#| renderings: [light, dark]
#| echo: false

ses_plot_p + theme_narsil()
ses_plot_p + theme_narsil_dark()
```
...
```{r}
#| label: ses-v-naive-plot-render
#| renderings: [light, dark]
#| echo: false

ses_v_naive_plot_p + scale_narsil()
ses_v_naive_plot_p + scale_narsil_dark()
```
...
```{r}
#| label: bra-pop-render
#| renderings: [light, dark]
#| echo: false

bra_pop_p + theme_narsil()
bra_pop_p + theme_narsil_dark()
```
...
```{r}
#| label: holt_full_plt-render
#| renderings: [light, dark]
#| echo: false

holt_full_plt_p + scale_narsil()
holt_full_plt_p + scale_narsil_dark()
```
...
```{r}
#| label: damped_full-render
#| renderings: [light, dark]
#| echo: false

damped_full_p + scale_narsil()
damped_full_p + scale_narsil_dark()
```
...
```{r}
#| label: aus-holidays-data-render
#| renderings: [light, dark]
#| echo: false

aus_holidays_data_p + theme_narsil()
aus_holidays_data_p + theme_narsil_dark()
```
...
```{r}
#| label: stl_ets_full-render
#| renderings: [light, dark]
#| echo: false

stl_ets_full_p + scale_narsil()
stl_ets_full_p + scale_narsil_dark()
```
...
```{r}
#| label: hw_full_plt-render
#| renderings: [light, dark]
#| echo: false

hw_full_plt_p + scale_narsil()
hw_full_plt_p + scale_narsil_dark()
```
...
```{r}
#| label: hw_damped-render
#| renderings: [light, dark]
#| echo: false

hw_damped_p + theme_narsil()
hw_damped_p + theme_narsil_dark()
```
...
```{r}
#| label: train-test-split-plt-render
#| renderings: [light, dark]
#| echo: false

train_test_split_plt_p + theme_narsil()
train_test_split_plt_p + theme_narsil_dark()
```
...
```{r}
#| label: all-models-fc-render
#| renderings: [light, dark]
#| echo: false

all_models_fc_p + scale_narsil()
all_models_fc_p + scale_narsil_dark()
```
