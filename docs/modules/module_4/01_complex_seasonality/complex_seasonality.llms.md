...
[![](complex_seasonality_files/figure-html/acf-plot-render-1.png)](complex_seasonality_files/figure-html/acf-plot-render-1.png)

[![](complex_seasonality_files/figure-html/acf-plot-render-2.png)](complex_seasonality_files/figure-html/acf-plot-render-2.png)
...
[![](complex_seasonality_files/figure-html/stl-decomp-plot-render-1.png)](complex_seasonality_files/figure-html/stl-decomp-plot-render-1.png)

[![](complex_seasonality_files/figure-html/stl-decomp-plot-render-2.png)](complex_seasonality_files/figure-html/stl-decomp-plot-render-2.png)
...
Recall from [Module 3.3](../../../../docs/modules/module_3/03_dynamic/dynamic_regression.llms.md#harmonic-regression) that Fourier terms approximate a seasonal pattern with K pairs of sine and cosine waves. For **multiple seasonalities**, we add one set per period:
