# Module 3 Review: Regression and Exogenous Variables
...
## 2 Part a — Exploratory Analysis and Data Preparation
...
>
> [![](review_module3_files/figure-html/nsw-data-1.png)](review_module3_files/figure-html/nsw-data-1.png)
>
...
>
> nsw_outliers |> select(Date, `log(Takings)`, remainder)
> ```
>
...
> ```
>
> [![](review_module3_files/figure-html/nsw-cpi-plot-1.png)](review_module3_files/figure-html/nsw-cpi-plot-1.png)
>
...
## 4 Part c — TSLM with Trend, Seasonality, and CPI
...
>     F-statistic:   188 on 5 and 62 DF, p-value: < 2.22e-16
>
...
> ```
>
> [![](review_module3_files/figure-html/tslm-residuals-1.png)](review_module3_files/figure-html/tslm-residuals-1.png)
>
> Code
>
> ``` r
...
>     AIC=-178.51   AICc=-175.89   BIC=-161.24
>
...
> ```
>
> [![](review_module3_files/figure-html/dynreg-residuals-1.png)](review_module3_files/figure-html/dynreg-residuals-1.png)
>
> Code
>
> ``` r
...
>
> For a quarterly series (m = 4), the maximum number of Fourier pairs is K\_{\max} = \lfloor m/2 \rfloor = 2.
>
...
>     AIC=-194.25   AICc=-192.38   BIC=-178.71
>
> Code
>
> ``` r
...
> ```
>
> The AICc values and fitted ARIMA orders for `harmonic_k2` and `dynamic` will be **identical or near-identical**, confirming the mathematical equivalence derived in e.1. The Fourier representation at K = K\_{\max} adds no new flexibility over `season()` for quarterly data — it simply uses a different basis for the same subspace.
>
...
> ```
>
> [![](review_module3_files/figure-html/prophet-components-1.png)](review_module3_files/figure-html/prophet-components-1.png)
>
...
## 8 Part g — Full Comparison and Conclusions
...
1.  Did adding CPI improve accuracy over the univariate Module 2 baseline? By how much?
2.  Did allowing ARIMA errors (dynamic regression) improve over TSLM? What does this imply about the residual structure of TSLM?
3.  Was `harmonic_k2` genuinely a different model from the dynamic regression in Part d? Explain in one sentence.
4.  In what context would Fourier regression be clearly preferable to `season()` dummies? Give a concrete example.
5.  For this dataset and horizon, which model would you deploy in production and why?
...
>
> [![](review_module3_files/figure-html/top-models-plot-1.png)](review_module3_files/figure-html/top-models-plot-1.png)
>
> **g.3 — Discussion**
>
...
>
> **c. `harmonic_k2` vs. dynamic regression:** They are the same model expressed in different bases — Fourier pairs at K = K\_{\max} = 2 for a quarterly series span exactly the same space as three seasonal dummies, so the fitted values, residuals, and forecasts are identical.
>
