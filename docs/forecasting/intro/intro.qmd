...
```{mermaid}
flowchart TD
    A(("There are two types of Data Scientists")) --> D@{ label: "Those who can't predict the future" } 
...
```{mermaid}
flowchart TD
    A(("There are two types of Data Scientists")) --> D@{ label: "Those who can't predict the future" } & E@{ label: "Those who don't know that they can't predict the future" }
