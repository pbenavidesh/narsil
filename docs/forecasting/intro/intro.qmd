...
# What are forecasts?{backgroung-color="black" background-image="saruman.jpeg" data-hide-slide-number="true"}

:::{.content-hidden when-format="revealjs"}
![](saruman.jpeg){width=100%}
:::
...
:::{.column width="60%"}
- Those who can't predict the future
:::
:::
...
- Those who can't predict the future
-
- Those who don't know that they can't predict the future
:::
...
## {auto-animate=true}
- **A**: There are two types of Data Scientists  
    → **B**: Those who can't predict the future


## {auto-animate=true}
- **A**: There are two types of Data Scientists  
    → **B**: Those who can't predict the future  
    → **C**: Those who don't know that they can't predict the future
